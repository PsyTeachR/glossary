...
A [data type](#data-type) representing <span class="shortdef">a real decimal number or integer</span>. The [integer](#integer) and [double](#double) data types are numeric.
