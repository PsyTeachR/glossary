...
A normal distribution is characterised by its [mean](#mean) and [standard deviation](#standard-deviation). You can sample numbers from a simulated normal distribution with the function `rnorm()`. 
