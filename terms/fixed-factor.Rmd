...
<dfn>A factor whose levels are assumed to represent all the levels of interest in a population; its levels would remain fixed across replications of the study.</dfn>
...
Fixed factors are usually contrasted with `r glossary("random factor", display="random factors")`, whose levels usually are assumed to be the result of (quasi-)random sampling.
