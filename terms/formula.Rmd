...
- `*` : means to take two (or more) predictors, and use their main effect AND also their interaction. `z*w` translates into `z + w + z:w`.
- `:` : refers to an interaction, without the main effects of the predictors.
...
More info about [adding random terms](https://bbolker.github.io/mixedmodels-misc/glmmFAQ.html#model-specification).
