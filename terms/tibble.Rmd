...
Tibbles are almost exactly like the [base R](b.html#base-r) `data.frame` container type, but has some special printing functions, does not coerce character columns to factors, and does not typically use row names.
