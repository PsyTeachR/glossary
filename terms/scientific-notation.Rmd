...
You can format numbers with scientific notation in R using the function `formatC()`. This turns them into text that you can use n inline code, but you can't use as a number anymore.
