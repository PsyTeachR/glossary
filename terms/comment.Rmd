...
<dfn>You can annotate `.R` files or [chunks](c.html#chunk) in `.Rmd` files with comments by prefacing each line of the comment with one or more hash symbols (`.html#`).</dfn>
