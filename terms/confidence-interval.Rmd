...
Most commonly cited Confidence Intervals are the 95% Confidence Interval and the 99% Confidence Interval. The 95CI and 99CI of the mean are calculated as follows:
...
For example, given $\mu$ = 10 and $SD$ = 1.25, the $95CI = [`r lowerCI`, `r upperCI`]$
