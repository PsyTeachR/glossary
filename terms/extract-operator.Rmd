...
<dfn>A symbol used to get values from a [container](#container) object, such as `[`, `[[`, or `$`</dfn>


You can extract values from a [vector](#vector) by [index](#index) or name using `[` and `[[`.
...
You can extract values from a [list](#list) by [index](#index) or name using `[` and `[[` and by name using `$`.
