...
<dfn>A type of regression model that involves estimating both `r glossary("fixed effect", display = "fixed effects")` and `r glossary("random effect", display = "random effects")`.</dfn>
