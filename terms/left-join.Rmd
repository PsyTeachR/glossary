...
<dfn>A [mutating join](f.html#mutating-joins) that keeps all the data from the first (left) table and joins anything that matches from the second (right) table.</dfn>
