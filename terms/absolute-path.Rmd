...
However, you should normally use [relative patha](r.html#relative-path) in scripts, not absolute paths, which can change when you move a project directory to a new computer or even a new place on your computer.
