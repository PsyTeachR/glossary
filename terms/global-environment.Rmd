...
When you create a variable, it is usually stored in the global environment. You can view this in the environment tab of the top right [pane](#panes) of RStudio.
